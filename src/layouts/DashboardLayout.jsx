...
const DashboardLayout = ({ children }) => {
  ...
  return (
    <div className="w-full h-screen bg-gray-100 flex items-center md:pl-8 font-opensans fixed">
      ...
      >
        <p className="text-sm text-gray-400 w-full px-2">Menu</p>
              ...
              <Link
                ...
                className={`${
                  location.pathname === item.to
                    ...
                    : "text-sky-400"
                } w-full p-2 rounded-lg flex items-center gap-4`}
              >
                {item.svg}
                {item.name}
              </Link>
        ...
        <p className="text-sm text-gray-400 w-full px-2">Admin</p>
        <ul className="w-full flex flex-col gap-2">
      ...
      <div className="w-full h-full flex flex-col">
        <div className="w-full h-[10vh] flex items-center justify-between text-sky-400 g px-4">
          <Link to="/" className=" flex gap-1 items-center text-sky-400 px-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <span className="flex gap-4 items-center">
            ...
            <button
              onClick={(e) => setOpen(!open)}
              className="p-1 max-md:block hidden"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
        ...
        <div className="w-full min-h-[90vh] overflow-auto">{children}</div>
      </div>
    </div>
  );
};
